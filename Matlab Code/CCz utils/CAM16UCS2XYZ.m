function XYZ = CAM16UCS2XYZ(JCh,XYZw,La,Yb,surround)
%%% CAM16-UCS implemented by MUHAMMAD SAFDAR and modified by Imran  
...
% JCh = Jab2JCh(JAB, La);
XYZ= CAM16_rev(JCh,XYZw,La,Yb,surround);
end

function XYZ = CAM16_rev(JCh,XYZw,La,Yb,Surround)
%%% XYZ is test XYZ [Nx3]
...
r=size(JCh,1);a=zeros(r,1);b=zeros(r,1);
